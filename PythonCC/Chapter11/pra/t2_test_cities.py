...
import unittest
from t2_city_function import city_country
...
class CitiesTestCase(unittest.TestCase):
    ...
    def test_city_country_population(self):
        """
        能够正确处理像Santiage， Chile - population 5000000
        这样的城市描述字符串吗?
        """
        city_country_str = city_country('santiage', 'chile', 5000000)
        self.assertEqual(city_country_str,
